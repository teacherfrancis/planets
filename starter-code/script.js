...
function createMobileMenu(planet) {
  ...
  chevron.src = "assets/icon-chevron.svg";

  navLink.appendChild(circle);
  navLink.appendChild(title);
  navLink.appendChild(chevron);
  mobileMenu.append(navLink);
}
...
function updateSelectedPlanet(navLink, planet, index) {
  ...
  if (previousSelectedNavLink) {
    delete previousSelectedNavLink.dataset.selected;
...
function updateSelectedTab(index, tab) {
  ...
  if (previousSelectedTab) {
    delete previousSelectedTab.dataset.selectedtab;
  }
